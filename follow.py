__author__ = "Ritav, Harsh, Sristi, Charitha, Samarth"
...
def find_follow(grammar):
    ...
    for everySymbol in list_of_symbols_in_order:
        ...
        process_productions_found(
            productions_found, first, follow_dictionary, follow_not_found_dictionary, everySymbol)
                        ...
                        if((i+1) == len(eachRightHandSide)):
                            ...
                            if not(eachLeftHandSide == eachRightHandSide[i]):
                                ...
                                if len(follow[eachLeftHandSide]) == 0:
                                    ...
                                    follow_not_found_dictionary[symbol].append(
                                        eachLeftHandSide)
                                else:
